...
<html>
    <head>
        <link rel="stylesheet" href="../css/admineditoperator.css">
    </head>
    <body>
        <div class="content">
            <form action="" method="POST"> 
            <h2 >OPERATOR</h2>
                <label>OPERSTOR ID </label><br />
                <input type="text" name="userid" placeholder="Operator Id" class="txtbox" required/>
                <br /><br />
                ...
                <input type="text" name="options" value="operator" placeholder="option"class="txtbox"  />
                <br /> <br />
                ...
                <a href="admineditoperatorview.php" target="myFrame"> <input type="button" value="VIEW" name="search"></a>
            </form>
        </div>
    </body>
</html>
...
$result = mysqli_query($connection,$sql);
if($result){
echo"<script> alert('DELETD!')</script>";
}
else{
    echo"<script> alert('[EORR ! [DELETING]')</script>";
}
